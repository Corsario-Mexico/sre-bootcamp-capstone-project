...
class TestStringMethods(unittest.TestCase):
    ...
    def test_invalid_cidr_to_mask(self):
        ...
        self.assertEqual("Invalid", self.convert.cidr_to_mask(16.5))
        self.assertEqual("Invalid", self.convert.cidr_to_mask("Hola"))
    ...
    def test_invalid_mask_to_cidr(self):
        ...
        self.assertEqual("Invalid", self.convert.mask_to_cidr("a.b.c.d"))
        self.assertEqual("Invalid", self.convert.mask_to_cidr("0.0.0.1"))
        self.assertEqual("Invalid", self.convert.mask_to_cidr("255.0.255.255"))
        self.assertEqual("Invalid", self.convert.mask_to_cidr("...."))
        self.assertEqual("Invalid", self.convert.mask_to_cidr("128.5,0,0,0"))
    ...
    def test_invalid_ipv4(self):
        ...
        self.assertFalse(self.validate.ipv4_validation("128.128.0"))
        self.assertFalse(self.validate.ipv4_validation("10.0.0.256"))
        self.assertFalse(self.validate.ipv4_validation("-1.0.0.0"))
